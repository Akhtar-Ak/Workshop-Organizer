        ...
        <div class="row">
            <div class="col-sm-6 offset-sm-1">
                ...
                <div class="signup-left position-fixed text-center">
                    ...
                    <img width="200" height="200" src="img/workshoplogo.png">
                    <br><br><br>
                    <?php
                    ...
                    <form id="signup-form" action="includes/signup.inc.php" method='post'
                        ...
                        <input type="submit" class="btn btn-light btn-lg" name="signup-submit" value="Submit">
            ...
            <div class="col-sm-6 offset-sm-6 text-center">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="headline">Preference</label>
                        <select class="form-control" name="preference" id="preference">
                            ...
                            <option value="9">Technical Difficulties</option>
