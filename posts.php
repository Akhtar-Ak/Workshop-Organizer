...
$sql  = "select * from topics, users, categories where topic_id=? "
...
<div class="container">
    <div class="col-sm-12">
        ...
        <?php
        $date1    = date("Y-m-d");
        $date2    = $forum['topic_date'];
        $diff_sec = abs(strtotime($date2) - strtotime($date1));

        ?>
        <div class="card post-header text-center">
            <img class="blog-cover" src="<?php echo $forum['topic_img']; ?>">
            <div class="px-5">
                <div class="text-center px-5">
                    ...
                    <h3>Workshop Countdown</h3>
                    <br>

                    <div class="clock" style="margin-left:5%;"></div>
                    <div class="message"></div>
                    <br><br>
                    <h4 class="text-muted text-left"><b>Speaker: </b><?php echo $forum['topic_speaker'] ?></h4>
                    <br><br>
                    <p class="text-justify"><?php echo $forum['topic_detail'] ?></p>

                    <br>
                    <p class="text-muted text-left">Organized By: <?php echo ucwords($forum['uidUsers']); ?></p>
