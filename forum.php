...
<main role="main" class="container">
    <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
            <h1 class="mb-0 text-white lh-100">Workshops</h1>
                ...
                echo '<a href="topics.php?cat=' . $row['cat_id'] . '">
                        <div class="media text-muted pt-3">
                            ...
                            <span class="text-right text-primary"> 
                                Workshops: ' . $row['forums'] . ' <i class="fa fa-book" aria-hidden="true"></i><br>';
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h5 class="border-bottom border-gray pb-2 mb-0">Top Workshops</h5>
        ...
        <small class="d-block text-right mt-3">
            <a href="create-topic.php" class="btn btn-primary">Create A Workshops</a>
            <a href="topics.php" class="btn btn-primary">All Workshops</a>
        </small>
