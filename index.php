...
<div id="loader-wrapper">
    <img src='img/workshoplogo.png' id='loader-logo'>
    <div class="loader">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                ...
                <div class="text-center p-3">
                    <img src="img/workshoplogo.png" width="170" height="170">
                ...
                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="forum-tab" data-toggle="tab" href="#forum" role="tab"
                           aria-controls="forum" aria-selected="true">Recent Workshops</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                        ...
                        <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                            <img class="mr-3" src="img/workshoplogo.png" alt="" width="48" height="48">
                            <div class="lh-100">
                                <h1 class="mb-0 text-white lh-100">Latest Workshops</h1>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            $sql  = "select topic_id, topic_subject, topic_date, topic_cat, topic_by, topic_img  , userImg, idUsers, uidUsers, cat_name, (
                                                ...
                                                where topics.topic_by = users.idUsers AND topics.topic_cat = '".$_SESSION['preference']."'
                            ...
                            if (!mysqli_stmt_prepare($stmt, $sql)) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $later   = new DateTime($row['topic_date']);
                                    ...
                                    echo '<div class="col-md-6">
                                                        ...
                                                        <img class="card-img-left flex-auto d-none d-lg-block blogindex-cover" 
                                                                src="' . $row['topic_img'] . '" alt="Card image cap">
                                                                </a>
                                                          <div class="card-body d-flex flex-column align-items-start">
                                                          
                                                            <h5 class="mb-0 mb-auto">
                                                              <a class="text-dark" href="posts.php?topic=' . $row['topic_id'] . '">'
                                        . substr(ucwords($row['topic_subject']), 0, 15) . '...</a>
                                                            </h5>
                                                            <small class="text-primary" >' . $diff . ' days remaining </small>
                                                            <small class="card-text ">Created By: ' . ucwords($row['uidUsers']) . '</small>
                                                            <a href="posts.php?topic=' . $row['topic_id'] . '">Go To Workshop</a>
                                                          </div>
                            ...
                            <a href="forum.php" class="btn btn-secondary btn-lg btn-block">View All Workshops</a>
                        </div>
                    ...
                    <div class="tab-pane fade" id="blog" role="blog" aria-labelledby="blog-tab">
                        ...
                        <div class="row mb-2">
                            ...
                            <a href="hub.php" class="btn btn-secondary btn-lg btn-block">View All Blogs</a>
                        </div>
            ...
            <div class="col-sm-2">
                ...
                <br><br><br>
                <a href="create-topic.php" class="btn btn-warning btn-lg btn-block">Create Workshops</a>
                <a href="create-blog.php" class="btn btn-secondary btn-lg btn-block">Create Blog</a>
